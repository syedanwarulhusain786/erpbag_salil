...
from . import views
urlpatterns = [
    path('accept_sales_order/<int:sale_number>/', views.accept_sales_order, name='accept_sales_order'),
    path('requirements/<int:sales_id>/', views.sales_order_requirements, name='sales_order_requirements'),
    ...
    path('allsales_list/', views.allsales_list, name='allsales_list'),
    
    
    path('create_quotation/', views.create_quotation, name='create_quotation'),
    path('quote-list/', views.quoteOrderList, name='quotelist'),
    path('allquote_list/', views.allquoteOrderList, name='allquote_list'),
